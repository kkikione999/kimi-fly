...
- 对应的任务文档是否存在 (`docs/exec-plans/active/task-{NNN}-*.md`)
- 是否基于最新 main 分支
...
**关键文件**:
```
ralph-loop-session/pr-review-status.md
```
...
- `docs/harness-deviation.md` - 流程偏差记录
- `ralph-loop-session/pr-review-status.md` - PR 审查状态
