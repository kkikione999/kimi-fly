...
### 3.4 ESP32-C3 WiFi 模块

| ESP32-C3 引脚 | 功能 | 连接 | 说明 |
|------------|------|------|------|
| 3V3 | - | 3V3_RF | 电源 (3.3V) |
| GND | - | GND | 地 |
| EN | - | 3V3_RF | 使能 |
| IO0 | - | BOOT_IO9 | 启动模式/下载 |
| IO1 | - | - | TXD0 |
| IO2 | - | - | - |
| IO3 | - | - | RXD0 |
| IO4 | - | - | - |
| IO5 | - | - | - |
| IO6 | - | - | (连接SPI Flash，通常不使用) |
| IO7 | - | - | (连接SPI Flash，通常不使用) |
| IO8 | - | - | (连接SPI Flash，通常不使用) |
| IO9 | - | BOOT_IO9 | 启动模式 |
| IO10 | - | STM_SPI_NSS1 | SPI 片选 |
| IO18 | - | STM_SPI_CLK1 | SPI 时钟 |
| IO19 | - | STM_SPI_MOSI1 | SPI MOSI |
| RXD0 | - | STM_TXD2 | UART 接收 (来自STM32 TXD2) |
| TXD0 | - | STM_RXD2 | UART 发送 (到STM32 RXD2) |
| RST | - | NRST | 复位 |
